...
if (typeof element2 != "undefined" && element2 != null) {
  ...
  function addTeam(guessNum) {
    switch (guessNum) {
      case 0:
        let player1Team = document.createTextNode(
          " - " + playerSet.player1Team
        );
        player1Txt.appendChild(player1Team);
        break;
      case 1:
        let player2Team = document.createTextNode(
          " - " + playerSet.player2Team
        );
        player2Txt.appendChild(player2Team);
        break;
      case 2:
        let player3Team = document.createTextNode(
          " - " + playerSet.player3Team
        );
        player3Txt.appendChild(player3Team);
        break;
      case 3:
        let player4Team = document.createTextNode(
          " - " + playerSet.player4Team
        );
